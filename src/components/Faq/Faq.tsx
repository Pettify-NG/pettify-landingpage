...
export default function Faq() {
  const faqs = [
    { question: 'What is Pettify?', answer: 'Pettify is an online marketplace for pet lovers, trusted breeders, pet vendors, and veterinarians. You can buy & sell pets, pet accessories, book vet appointments, and much more.' },
    ...
    { question: 'How do I list a pet for sale?', answer: 'If you’re a breeder or vendor, you can sign up on the Pettify web app at www.pettify.co and start listing pets for sale. Provide detailed descriptions such as category, breed, age, vaccination details, and clear beautiful pet photos to attract eager buyers.' },
    ...
    { question: 'Can I get a refund for my purchase?', answer: 'Refund policies are determined by Pettify only if the received pet was in bad condition or false pet delivery. We also refund canceled vet appointments. Please contact Pettify through email at hello@pettify.co for any refund requests or help.' },
  ...
  // Correctly define state at the top level
  const [openIndex, setOpenIndex] = useState<number | null>(null);

  // Fix toggleFAQ function
  ...
  return (
    <div className='max-w-3xl mx-auto p-6' id='faq'>
      ...
      {faqs.map((faq, index) => (
        <div key={index} className='mb-4 border-b border-gray-300 pb-2 hover:scale-95 transition-transform'>
          <button
